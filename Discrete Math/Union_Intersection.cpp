/*
    This program finds the union (called merger for error purposes) and intersection of two sets with the size of n given by the user.
*/

using namespace std;
#include <iostream>

//Class with the necessary variables and methods
class Set {
    public:
